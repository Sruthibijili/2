...
\begin{enumerate} [start=5]
    ...
    \begin{enumerate}
        ...
        \item $25$
    \end{enumerate}
    \item Let $b_{i}$$>$$1$ for i$=$$1,2,.....101$.Suppose $\log_eb_{1}$,$\log_eb_{2}$,.......$\log_eb_{101}$ are in Arithmetic Progression \brak{A.P} with the common difference $\log_e2$.Suppose $a_{1}$,$a_{2}$,......$a_{101}$ are in A.P.such that $a_{1}$,$=$$b_{1}$ and $a_{51}$$=$$b_{51}$.If t$=$$b_{1}$$+$$b_{2}$$+$...$+$$ and b_{51}$ s$=$$a_{1}$$+$$a_{2}$$+$...$a_{53}$, then 
    \hfill(JEE ADV.2016)
    \begin{enumerate}
